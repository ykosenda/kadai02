...
function playRound(playerSelection) {
  ...
  if (computerSelection === "グー") {
    computerHandImage = "gu.png";
  } else if (computerSelection === "チョキ") {
    computerHandImage = "choki.png";
  } else {
    computerHandImage = "pa.png";
  }
  ...
  document.querySelector("#total-wins").textContent = `累計${winCount}勝 / ${roundsPlayed}試合`;


  if (winCount >= 5) {
    document.querySelector("#total-wins").style.color = "green";
    document.querySelector("#total-wins").textContent += "あなたはじゃんけんが強いです！";
